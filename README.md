...
The water scrolls horizontally with foam that scrolls at a different speed to create a more natural water effect. It takes in a water texture, foam texture, and scroll x speed. It scrolls the water and foam uvs by adding a float2 with the scroll x speed and no y value so the water only scrolls horizontally, then multiplying it by _Time.y for the water and _Time.y * 0.5 for the foam so they scroll at different speeds. The textures are then sampled with the scrolled uv data and added together then multiplied by 0.5 so they don't get too bright after being added together. 
...
<img width="2096" height="299" alt="image" src="https://github.com/user-attachments/assets/57c3509e-55c4-47b8-b26b-605ab7eca4be" />
